...
export const PulseBeams = ({
  ...
  return (
    <div
      className={cn("w-full h-screen relative flex items-center justify-center antialiased overflow-hidden", className)}
    >
      {background}
...
const SVGs = ({ beams, width, height, baseColor, accentColor, gradientColors }) => {
  return (
    ...
    >
      {beams.map((beam: { path: string | undefined; connectionPoints: any[] }, index: React.Key | null | undefined) => (
